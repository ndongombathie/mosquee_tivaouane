...
export const  categories = [
  {
    ...
    en: 'Prayer spaces',
    lieux: [
      { name: { fr: 'Salle de prière principale', ar: 'قاعة الصلاة الرئيسية', wo: 'Kër jumma bu mag', en: 'Main prayer hall' }, desc: { fr: "Lieu central pour les prières collectives.", ar: "المكان المركزي للصلاة الجماعية.", wo: "Fenn bu mag ngir jëmm.", en: "Central place for collective prayers." }, img: hall }
    ]
  },
  {
    key: 'architecture',
    ...
    en: 'Architecture',
    lieux: [
      { name: { fr: 'Minaret', ar: 'المئذنة', wo: 'Minare', en: 'Minaret' }, desc: { fr: "Tour emblématique pour l'appel à la prière.", ar: "برج مميز للأذان.", wo: "Tur bu mag ngir woy.", en: "Iconic tower for the call to prayer." }, img: centre },
      { name: { fr: 'Mihrab', ar: 'المحراب', wo: 'Mihrab', en: 'Mihrab' }, desc: { fr: "Niche indiquant la direction de la Mecque.", ar: "مكان يحدد اتجاه مكة.", wo: "Niche ngir jëmm ci Maka.", en: "Niche indicating the direction of Mecca." }, img: "https://images.unsplash.com/photo-1500534314209-a25ddb2bd429" }
    ]
  },
  {
    key: 'espaces',
    ...
    en: 'Community spaces',
    lieux: [
      { name: { fr: 'Cour intérieure', ar: 'الفناء الداخلي', wo: 'Kaw bu ca biir', en: 'Inner courtyard' }, desc: { fr: "Espace ouvert pour la communauté.", ar: "مساحة مفتوحة للمجتمع.", wo: "Kaw bu leer ngir askan wi.", en: "Open space for the community." }, img: "https://images.unsplash.com/photo-1464983953574-0892a716854b" }
    ]
  },
  {
    key: 'savoir',
    ...
    en: 'Knowledge & study',
    lieux: [
      { name: { fr: 'Bibliothèque', ar: 'المكتبة', wo: 'Biiblioteek', en: 'Library' }, desc: { fr: "Lieu de savoir et d'étude.", ar: "مكان للعلم والدراسة.", wo: "Fenn bu xam-xam ak jàng.", en: "Place of knowledge and study." }, img: "https://images.unsplash.com/photo-1465101046530-73398c7f28ca" }
    ]
  }
];
        ...
        {categories.map(cat => (
          <div key={cat.key} className="mb-12">
            ...
            <div className="relative">
              ...
              >
                {cat.lieux.map((lieu, idx) => (
                  <div
                    key={idx}
                    onClick={() => navigate(`/lieu/${cat.key}/${idx}`)}
